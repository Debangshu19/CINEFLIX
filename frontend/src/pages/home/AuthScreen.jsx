...
const AuthScreen = () => {
    ...
    const handleFormSubmit = (e) => {
		e.preventDefault();
		navigate("/signup?email=" + email); //navigate to signup page with email as query parameter
	};
  return (
    <div className='hero-bg relative'>
        {/* Navbar */}
		<header className='max-w-6xl mx-auto flex items-center justify-between p-4 pb-10'>
			<img src='/cineflix-logo.png' alt='Netflix Logo' className='w-32 md:w-52' />
		...
		<div className='flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto'>
            ...
            <form className='flex flex-col md:flex-row gap-4 w-1/2 py-8' onSubmit={handleFormSubmit}>
                <input
                    type='email'
